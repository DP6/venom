// Plugin Youtube Events
var YoutubeEvents = function (tracker, opts) {
	...
	var _gaTrackYoutube = function (opts) {
		...
		util.domReady(function () {
			_trackYoutube.call(self, opts);
		});
		return false;
	};

	_gaTrackYoutube(opts)

}


// Plugin Copy cookie to same domains
providePlugin('youtubeEvents', YoutubeEvents);
